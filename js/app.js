(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new core(".swiper", {
            ...
            pagination: {
                el: ".slider-about__dotts",
                clickable: true
            },
            navigation: {
                prevEl: ".slider-about__arrow_prev",
                nextEl: ".slider-about__arrow_next"
            },
            on: {}
        });
    }
    ...
    const constSmall = document.querySelector(".steps__card-small");
    const likeIcon = document.querySelector(".stats-item-steps__like");
    likeIcon.addEventListener("mouseover", (function(e) {
        constSmall.classList.add("_active");
    }));
    likeIcon.addEventListener("mouseout", (function(e) {
        constSmall.classList.remove("_active");
    }));
    const playIcon = document.querySelector(".play-actions-main__icon");
    const videoBlock = document.querySelector(".main__popup-video");
    window.onload = function() {
        document.addEventListener("click", documentActions);
    };
    function documentActions(e) {
        const targetElement = e.target;
        if (targetElement.classList.contains("play-actions-main__icon")) videoBlock.classList.toggle("active"); else videoBlock.classList.remove("active");
    }
    playIcon.addEventListener("keyup", (function(event) {
        if ("Escape" === event.code) videoBlock.classList.toggle("active");
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
